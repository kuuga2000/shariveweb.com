...
<html>
	...
	<body>
		...
		<div class="thumb">
			<ul>
				<li>
					<img class="thumb-image" src="./elevatezoom-master/images/thumb/mbf.jpg" img-large="./elevatezoom-master/images/large/mbf.jpg" img-small="./elevatezoom-master/images/small/mbf.jpg" />
				</li>
				<li>
					<img class="thumb-image" src="./elevatezoom-master/images/thumb/mbf2.jpg" img-large="./elevatezoom-master/images/large/mbf2.jpg" img-small="./elevatezoom-master/images/small/mbf2.jpg" />
				</li>
				<li>
					<img class="thumb-image" src="./elevatezoom-master/images/thumb/mbf3.jpg" img-large="./elevatezoom-master/images/large/mbf3.jpg" img-small="./elevatezoom-master/images/small/mbf3.jpg" />
				</li>
				<li>
					<img class="thumb-image" src="./elevatezoom-master/images/thumb/mbf4.jpg" img-large="./elevatezoom-master/images/large/mbf4.jpg" img-small="./elevatezoom-master/images/small/mbf4.jpg" />
				</li>
			</ul>
		</div>
